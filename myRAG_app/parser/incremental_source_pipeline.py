...
DEFAULT_STATE_PATH = Path("myRAG_app/.state/incremental_source_manifest.json")
DEFAULT_MARKDOWN_OUTPUT_DIR = Path("myRAG_app/markdown_knowledge_incremental")
...
def _probe_with_skill_wrapper(
    *,
    ...
    cmd = [
        "bash",
        str(repo_root / "myRAG_app/skills/pptx-rag-parser/scripts/run_pptx_probe.sh"),
        "--pptx-path",
        str(input_path),
        "--report-path",
        str(report_path),
