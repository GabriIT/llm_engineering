...
DEFAULT_ACTIVE_DB_PATH = os.getenv("MYRAG_DB_PATH", str(DEFAULT_MARKDOWN_DB_PATH))
DEFAULT_ACTIVE_COLLECTION = os.getenv("MYRAG_COLLECTION", DEFAULT_MARKDOWN_COLLECTION)
